package com.khorkor.coderswag.Adapters
...
class ProductAdapter(val context : Context, val products: List<Product>) : RecyclerView.Adapter<ProductAdapter.ProductHolder>() {
    ...
    inner class ProductHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindProduct(product: Product, context: Context){
            val resourrceID = context.resources.getIdentifier(product.image,"drawable",context.packageName)
            productImage.setImageResource(resourrceID)
